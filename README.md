# Проект по автоматизации тестирования для компании [<img width="30%" title="IntelliJ IDEA" src="images/logo/alfa.svg">](https://alfabank.ru/)
...
## <img src="images/logo/Jenkins.svg" title="Jenkins" width="4%"/> Сборка в [Jenkins](https://jenkins.autotests.cloud/job/kperevereva_properties_alfatests/)
<p align="center">
...
## <img src="images/logo/Jira.svg" title="Jira" width="6%"/> Интеграция с [Jira](https://jira.autotests.cloud/browse/HOMEWORK-1584)
...
<p align="center">
<img title="Selenoid Video" src="images/video/Video_MD.gif" width="650" height="350"  alt="video">
</p>